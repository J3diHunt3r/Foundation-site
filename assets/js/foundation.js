...
/**code for carousel*/
var in_transition = false, // Vairable to ensure only one transition is happening at a time
    initial_load = true; // Variable for initial load so we animate in the first slide on load

$( document ).ready(function() {
  
  /* Initialise new Obit object */ 
  var orbit = new Foundation.Orbit($('#example'), {
      animation: 'fade',
      timerDelay: 5000,
      pauseOnHover: true,
      navButtons: true,
  ...
  /*creating thumbnail for product gallery*/
  ...
  // Enclosed animation function
  function fade_in_heading( element1, element2 ){
    if( in_transition == false ){
      
      in_transition = true;
      var element1 = element1,
          element2 = element2,
          fadeInTL = new TimelineLite({paused: true});
      ...
      function timeline_callback(){
        ...
        element2 = '';
        fadeInTL.stop().clear();
        fadeInTL.eventCallback("onComplete", null);
        fadeInTL.eventCallback("onUpdate", null);
        fadeInTL.eventCallback("onStart", null);
        fadeInTL = '';
      ...
      fadeInTL.from( element1, 0.8, { opacity: 0, y: "50", ease: Power2.easeOut }, 0.5 )
      .from( element2, 0.8, { opacity: 0, y: "50", ease: Power2.easeOut, onComplete: timeline_callback }, 0.5 );
  ...
  // On initial page load we want to animate in the first slide content
  if( initial_load == true ){
    initial_load = false;
    
     // Set element 1 and 2
    var element1 = $(".orbit-container > li:nth-of-type(1) h2" ), 
    element2 = $(".orbit-container > li:nth-of-type(1) p" ); 
    
    // Pass elements 1 and 2 to the animation function
    fade_in_heading( element1, element2 );
    
  }
  
  // Event fires before next slide is called
  $('#example').on('beforeslidechange.zf.orbit', function(event) {
    ...
    // Determin which slide is next
    $(".orbit-container > li").each(function( index ) {           
    ...
    // Set element 1 and 2
    element1 = $(".orbit-container > li:nth-of-type(" + ( child_index + 1 ) + ") h2" ); 
    element2 = $(".orbit-container > li:nth-of-type(" + ( child_index + 1 ) + ") p" ); 
